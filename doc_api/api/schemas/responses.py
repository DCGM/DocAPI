...
class AppCode(str, enum.Enum):
    ...
    JOB_UNCANCELLABLE = 'JOB_UNCANCELLABLE'
    ...
    JOB_INVALID_STATE_UPDATE = 'JOB_INVALID_STATE_UPDATE'
    JOB_UPDATED = 'JOB_UPDATED'
    JOB_UPDATE_NO_FIELDS = 'JOB_UPDATE_NO_FIELDS'
    JOB_LEASE_EXTENDED = 'JOB_LEASE_EXTENDED'
    JOB_LEASE_RELEASED = 'JOB_LEASE_RELEASED'
    JOB_UNFINISHABLE = 'JOB_UNFINISHABLE'
    JOB_MARKED_DONE = 'JOB_MARKED_DONE'
    JOB_ALREADY_MARKED_DONE = 'JOB_ALREADY_MARKED_DONE'
    JOB_MARKED_ERROR = 'JOB_MARKED_ERROR'
    JOB_ALREADY_MARKED_ERROR = 'JOB_ALREADY_MARKED_ERROR'
    ...
    PAGE_NOT_UPLOADED = 'PAGE_NOT_UPLOADED'
    META_JSON_NOT_UPLOADED = 'META_JSON_NOT_UPLOADED'

    IMAGE_GONE = 'IMAGE_GONE'
    ALTO_GONE = 'ALTO_GONE'
    PAGE_GONE = 'PAGE_GONE'
    META_JSON_GONE = 'META_JSON_GONE'
    ...
    KEY_SECRET_CREATED = 'KEY_SECRET_CREATED'
    KEY_CREATION_FAILED = 'KEY_CREATION_FAILED'
    KEY_SECRET_CREATION_FAILED = 'KEY_SECRET_CREATION_FAILED'
    KEY_NOT_FOUND = 'KEY_NOT_FOUND'
    KEY_UPDATED = 'KEY_UPDATED'
    KEY_UPDATE_NO_FIELDS = 'KEY_UPDATE_NO_FIELDS'
