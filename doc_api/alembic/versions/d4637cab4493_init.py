...
Revision ID: d4637cab4493
Revises: 
Create Date: 2025-10-29 14:15:49.208898
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('READONLY', 'USER', 'WORKER', 'ADMIN', name='keyrole'), nullable=False),
    ...
    op.create_index(op.f('ix_keys_kid'), 'keys', ['kid'], unique=True)
    ...
    sa.Column('page_required', sa.Boolean(), nullable=False),
    ...
    op.create_index(op.f('ix_jobs_page_required'), 'jobs', ['page_required'], unique=False)
    ...
    op.create_index(op.f('ix_images_page_uploaded'), 'images', ['page_uploaded'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_images_page_uploaded'), table_name='images')
    ...
    op.drop_index(op.f('ix_jobs_page_required'), table_name='jobs')
    ...
    op.drop_index(op.f('ix_keys_kid'), table_name='keys')
